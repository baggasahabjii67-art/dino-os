const seed=[
 {id:'solo-leveling',title:'Solo Leveling',author:'Chugong',status:'Reading',chapters:179,source:'MangaDex',cover:'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=600&q=85'},
 {id:'one-piece',title:'One Piece',author:'Eiichiro Oda',status:'Plan to read',chapters:1120,source:'MangaDex',cover:'https://images.unsplash.com/photo-1613376023733-0a73315d9b06?w=600&q=85'},
 {id:'chainsaw-man',title:'Chainsaw Man',author:'Tatsuki Fujimoto',status:'Reading',chapters:172,source:'AniList',cover:'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=600&q=85'},
 {id:'frieren',title:'Frieren: Beyond Journey’s End',author:'Kanehito Yamada',status:'Completed',chapters:140,source:'AniList',cover:'https://images.unsplash.com/photo-1535016120720-40c646be5580?w=600&q=85'}
];
...
export const store={
 ...
 get sources(){return JSON.parse(localStorage.getItem('manga-sources')||'null')||[{id:'mangadex',name:'MangaDex',repo:'Built-in catalog',status:'Ready'},{id:'anilist',name:'AniList',repo:'Built-in catalog',status:'Ready'}]},set sources(v){localStorage.setItem('manga-sources',JSON.stringify(v))}
};
